...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const firstCharactersNames = starWarsCharacters[i].name;
  charactersNames.push(firstCharactersNames);
}
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  const characterEyeColor = starWarsCharacters[i].eye_color;
...
while (indice < starWarsCharacters.length) {
  console.log(indice);
  let totalMass = starWarsCharacters[indice].mass;
  crewMass = crewMass + totalMass;
  indice++;
}
